...
<body style="font-family: 'Roboto', sans-serif; background: #f3f7fb; color: #444; line-height: 1.6; padding: 30px;">
    <div
        ...
        <div
            ...
            <div>
                <h1 style="font-size:2rem; letter-spacing:1px; margin:0;">
                    Nur<span style="color:#f5a623;">Barbershop</span>
                </h1>
        ...
        <div
            ...
            <p style="margin:5px 0;">Terima kasih telah menggunakan layanan Nur Barbershop</p>
            <p style="margin:5px 0;"> &copy; 2025 Nur Barbershop. All rights reserved.</p>
        </div>
    </div>
</body>
