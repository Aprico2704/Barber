            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 text-center">
                    <div class="breadcrumb-text">
                        <h1>Reservasi</h1>
                        <p>Revervasi disini agar lebih mudah</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 mb-5 mb-lg-0">
                    <div class="form-title text-center">
                        <h2>Reservasi di Barbershop Nur</h2>
                        <p>Booking potong rambut jadi lebih mudah di Barbershop Nur. 
                            Kami siap melayani Anda dengan sepenuh hati!</p>
                    </div>
                            ...
                            <div class="service-card p-3 rounded-3 border" 
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div class="barberman-image rounded-circle overflow-hidden" 
                                        ...
                                        <img src="public/storage/${barberman.foto}" alt="${barberman.name}" 
